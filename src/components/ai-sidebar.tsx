...
export default function AiSidebar({ editor }: { editor: Editor }) {
  return (
    <div className="w-[22rem] flex-shrink-0 rounded-l-md flex-grow-0 space-y-3 flex-col justify-between hidden lg:flex p-5 h-screen sticky top-0 right-0 overflow-y-auto">
