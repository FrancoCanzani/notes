      ...
      <ScrollArea className="thin-scrollbar h-[225px]">
        {options.map((option) => (
          <button
            ...
            className="flex disabled:opacity-50 my-1.5 hover:bg-bermuda-gray-200 bg-bermuda-gray-50 p-2.5 rounded-lg w-full text-sm disabled:cursor-not-allowed items-center justify-start gap-x-2"
            key={option.value}
            disabled={
